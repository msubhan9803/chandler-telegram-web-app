...
const BuyAllHeaderDiv = ({
  ...
  return (
    <>
      {!providingCrypto.name && !receivingCrypto.name ? (
        <div className="h-40 flex w-full rounded-lg bg-zinc-700 justify-center items-center m-auto">
          <Spinner />
        </div>
      ) : (
              ...
              <div className="flex flex-col items-start justify-start space-y-2">
                ...
                <div className="flex flex-row items-start justify-start space-x-4">
                  ...
                  <div className="font-montserrat">
                    {providingCrypto.amount}{" "}
                    {providingCrypto.name.toUpperCase()}
                  </div>
                </div>
                <div className="flex flex-row items-start justify-start space-x-4">

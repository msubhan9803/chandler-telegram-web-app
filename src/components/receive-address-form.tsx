...
const ReceiveAddressForm: NextPage<ReceiveAddressFormType> = ({
  ...
  return (
    <form className="flex flex-col items-start justify-start gap-[9px] w-full">
      ...
      <input
        className="font-montserrat text-sm bg-[transparent] rounded-8xs overflow-hidden flex flex-row p-2.5 items-start justify-center border-[2px] border-solid border-zinc-700 w-full rounded-lg"
        type="text"

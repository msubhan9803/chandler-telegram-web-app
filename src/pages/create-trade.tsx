    ...
    <div className="relative rounded-t-3xs rounded-b-none bg-caldera-l-blue w-full flex flex-col py-[9px] px-2.5 box-border items-start justify-start text-left text-sm text-white font-montserrat">
      <div className="flex flex-col items-center justify-center gap-[18px]">
        <div className="rounded-xl bg-dark-gray shadow-[0px_4px_4px_rgba(0,_0,_0,_0.25)] overflow-hidden flex flex-col p-[9px] items-center justify-start gap-[18px]">
          <div className="relative font-medium">Trading:</div>
          <div className="relative box-border w-[241px] h-px shrink-0 border-t-[1px] border-solid border-dark-gray" />
        ...
        <div className="rounded-xl bg-dark-gray shadow-[0px_4px_4px_rgba(0,_0,_0,_0.25)] w-[340px] h-[75px] shrink-0 overflow-hidden flex flex-col py-2.5 px-[15px] box-border items-center justify-center gap-[10px]">
          <div className="relative font-medium">Seeking:</div>
          <div className="relative box-border w-[241px] h-px shrink-0 border-t-[1px] border-solid border-jet-black" />
          <div className="relative font-light">Select Coin ...</div>
        </div>
      </div>
    </div>
  );
